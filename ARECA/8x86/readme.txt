...
******************************************************************************************
P.S: Areca SCSIPORT PCI RAID Host adapter Driver does not support Windows 8 or later.
     Please Use Areca STORPORT PCI RAID Host adapter Driver for your need.
     Areca's Windows XP (32bits) and Windows 2000 SCSIPORT driver does not be supported from driver version 6.20.00.24. 

     Driver version 6.20.00.24 totally works on "message signal interrupt".
     If you try to update your "legacy interrupt" driver 6.20.00.23 into 6.20.00.24, 

     You need to uninstall the old driver:
     from 
          "Device manager" => "Storage Controllers" => "ARECA (X86-32-STORPORT) SAS RAID Host Adapter (RAID6-ENGINE Inside)"   
          => "Uninstall" (Delete the driver software for this device) => "RAID controller" 
     and then  
          "RAID controller" => "ARECA (X86-32-STORPORT) SAS RAID Host Adapter (RAID6-ENGINE Inside)"  
